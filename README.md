...
> [!NOTE]
> This is a port of [aminought/firefox-second-sidebar](https://github.com/aminought/firefox-second-sidebar) adapted for **Zen Browser** by [Ezo-mas](https://github.com/Ezo-mas/zen-second-sidebar-fix), with additional enhancements and Sine loader support added by [sinazadeh](https://github.com/sinazadeh/zen-second-sidebar-enhanced). Compared to upstream Firefox Second Sidebar, this fork additionally provides:
>
...
2. In Sine's mod manager, add a mod from a repository and enter:
   ```
   Ezo-mas/zen-second-sidebar-fix/tree/master
   ```
